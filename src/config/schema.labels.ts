...
export const FIELD_LABELS: Record<string, string> = {
  ...
  system: "System",
  "system.os": "OpenClaw OS",
  "system.os.security": "OpenClaw OS Security",
  "system.os.security.profile": "OpenClaw OS Security Profile",
  "system.os.boot": "OpenClaw OS Boot",
  "system.os.boot.integrity": "OpenClaw OS Boot Integrity",
  "system.os.runtime": "OpenClaw OS Runtime",
  "system.os.runtime.sandbox": "OpenClaw OS Runtime Sandbox Policy",
  "system.os.privacy": "OpenClaw OS Privacy",
  "system.os.privacy.inferenceRouting": "OpenClaw OS Inference Routing Policy",
  "system.os.telemetry": "OpenClaw OS Telemetry",
  "system.os.telemetry.enabled": "OpenClaw OS External Telemetry Enabled",
  "system.os.autonomy": "OpenClaw OS Agent Autonomy",
  "system.os.autonomy.enabled": "OpenClaw OS Agent Autonomy Enabled",
  "system.os.autonomy.defaultModel": "OpenClaw OS Default Autonomous Model",
  "system.os.apps": "OpenClaw OS Local Apps",
  "system.os.apps.autoInstall": "OpenClaw OS App Auto Install",
  "system.os.apps.simple": "OpenClaw OS Simple App Generation",
  "system.os.apps.simple.model": "OpenClaw OS Simple App Local Model",
  "system.os.apps.fromScratch": "OpenClaw OS From-Scratch App Generation",
  "system.os.apps.fromScratch.requireProviders":
    "OpenClaw OS From-Scratch Required Cloud Providers",
  "system.os.apps.fromScratch.anthropicModel": "OpenClaw OS From-Scratch Anthropic Model",
  "system.os.apps.fromScratch.openaiModel": "OpenClaw OS From-Scratch OpenAI Model",
