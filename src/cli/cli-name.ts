...
export const CLI_ALIAS_NAME = "claos";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, CLI_ALIAS_NAME]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(openclaw|claos)\b/;
